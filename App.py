...
st.title('Grupos de interesses para marketing ')
st.write("""
...
up_file = st.file_uploader('Insira o arquivo CSV para fazer a previsão', type = 'csv')
...
if up_file is not None:
    ...
    st.download_button(label = 'Baixar resultados', data = csv, file_name = 'Grupos_interesse.csv', mime = 'text/csv')